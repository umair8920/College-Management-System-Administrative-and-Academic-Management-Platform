		...
		<div class="row justify-content-center ">
			<div class="col-xxl-8 col-xl-10 col-lg-11 col-md-12 col-sm-12 col-12">
				<div class="hero-content hero-content-style-3 text-center">
					<h2>Looking for <a href="contact">help</a> from premier Assignment.</h2>
					<h1>Assignment Help Service in the World.</h1>
               <div class="hero-btn-wrap">
                  <a class="common-btn" href="service">Read More About +</a>
               </div>
				</div>
			</div>
		</div>
	</div>
	<img class="shape hero-shape-3" src="{{ asset('Frontend_assets/images/shape/hero-shape-3.png') }}" alt="">
</div>
										...
										<div class="row">
											...
											<div class="col-xl-6 col-lg-6 col-sm-12 col-12">
												<div class="input-file-upload position-relative">
													<input type="file">
													<img src="{{ asset('Frontend_assets/images/icon/upload-icon-2.png') }}" alt="">
											...
											<div class="col-xl-2 col-lg-3 col-sm-12 col-12">
												<div class="assignment-btn-wrap text-center">
													<button type="submit" class="assignment-btn">Let’s start +</button>
												</div>
											</div>
										</div>
									</form>
							...
							<div class="row justify-content-between align-items-center">
								<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
									<div class="service-tab-img overflow-hidden">
										<img class="w-100" src="{{ asset('Frontend_assets/images/service-tab-img-1.png') }}" alt="">
									</div>
								</div>
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="team-cta-wrap text-center">
					...
					<div class="team-cta-btn-wrap wow flipInX" data-wow-duration="2.5s" data-wow-delay=".4s">
						<a class="common-btn" href="about-us">Read More About +</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="service-tab-slide-wrap owl-carousel mt-60">
			<div class="row">
				<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="single-courses-box single-courses-box-2">
						<div class="courses-img">
							<a href="case-details"><img class="w-100" src="{{ asset('Frontend_assets/images/courses/course-img-1.png') }}" alt=""></a>
						</div>
						<div class="courses-content">
							...
							<h3><a href="case-details">2022 Complete Python Bootlace Zero to Hero in Python.</a></h3>
							<p>$59.39</p>
							<div class="courses-meta">
								<ul>
									<li><a href="#"><i class="bi bi-person-circle"></i> Brooke Cagle</a></li>
									<li><a href="#"><i class="bi bi-book"></i> 05 Assign <span>/ Class 6</span></a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="single-courses-box single-courses-box-2">
						<div class="courses-img">
							<a href="case-details"><img class="w-100" src="{{ asset('Frontend_assets/images/courses/course-img-2.png') }}" alt=""></a>
						</div>
						<div class="courses-content">
							<div class="courses-rating">
								<ul>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="single-courses-box single-courses-box-2">
						<div class="courses-img">
							<a href="case-details.html"><img class="w-100" src="{{ asset('Frontend_assets/images/courses/course-img-3.png') }}" alt=""></a>
						</div>
						<div class="courses-content">
							<div class="courses-rating">
								<ul>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="single-courses-box single-courses-box-2">
						<div class="courses-img">
							<a href="case-details"><img class="w-100" src="{{ asset('Frontend_assets/images/courses/course-img-4.png') }}" alt=""></a>
						</div>
						<div class="courses-content">
							<div class="courses-rating">
								<ul>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="single-courses-box single-courses-box-2">
						<div class="courses-img">
							<a href="case-details"><img class="w-100" src="{{ asset('Frontend_assets/images/courses/course-img-5.png') }}" alt=""></a>
						</div>
						<div class="courses-content">
							<div class="courses-rating">
								<ul>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="single-courses-box single-courses-box-2">
						<div class="courses-img">
							<a href="case-details"><img class="w-100" src="{{ asset('Frontend_assets/images/courses/course-img-6.png') }}" alt=""></a>
						</div>
						<div class="courses-content">
							<div class="courses-rating">
								<ul>
			...
			<div class="row">
				...
				<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="single-courses-box single-courses-box-2">
						<div class="courses-img">
							<a href="case-details"><img class="w-100" src="{{ asset('Frontend_assets/images/courses/course-img-3.png') }}" alt=""></a>
						</div>
						<div class="courses-content">
							<div class="courses-rating">
								<ul>
		...
		<div class="row row-cols-1 row-cols-xl-5 row-cols-xxl-6 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 mt-60">
			<div class="col wow fadeIn" data-wow-duration="2.5s" data-wow-delay=".7s">
				<div class="team-box team-box-design-2">
					<div class="team-img">
						<a href="teachers-details"><img class="w-100" src="{{ asset('Frontend_assets/images/team/team-1.png') }}" alt=""></a>
					</div>
					<div class="team-content-wrap d-flex align-items-center justify-content-between">
						<div class="team-content">
							<h3><a href="teachers-details">Oliver Ava</a></h3>
							<p>Educoda Manager</p>
						</div>
			...
			<div class="col wow fadeIn" data-wow-duration="2.5s" data-wow-delay=".8s">
				<div class="team-box team-box-design-2">
					<div class="team-img">
						<a href="teachers-details"><img class="w-100" src="{{ asset('Frontend_assets/images/team/team-2.png') }}" alt=""></a>
					</div>
					<div class="team-content-wrap d-flex align-items-center justify-content-between">
						<div class="team-content">
							<h3><a href="teachers-details">Oliver Ava</a></h3>
			...
			<div class="col wow fadeIn" data-wow-duration="2.5s" data-wow-delay=".9s">
				<div class="team-box team-box-design-2">
					<div class="team-img">
						<a href="teachers-details"><img class="w-100" src="{{ asset('Frontend_assets/images/team/team-3.png') }}" alt=""></a>
					</div>
					<div class="team-content-wrap d-flex align-items-center justify-content-between">
						<div class="team-content">
							<h3><a href="teachers-details">Oliver Ava</a></h3>
			...
			<div class="col wow fadeIn" data-wow-duration="2.5s" data-wow-delay="1s">
				<div class="team-box team-box-design-2">
					<div class="team-img">
						<a href="teachers-details"><img class="w-100" src="{{ asset('Frontend_assets/images/team/team-4.png') }}" alt=""></a>
					</div>
					<div class="team-content-wrap d-flex align-items-center justify-content-between">
						<div class="team-content">
							<h3><a href="teachers-details">Oliver Ava</a></h3>
			...
			<div class="col wow fadeIn" data-wow-duration="2.5s" data-wow-delay="1.1s">
				<div class="team-box team-box-design-2">
					<div class="team-img">
						<a href="teachers-details"><img class="w-100" src="{{ asset('Frontend_assets/images/team/team-5.png') }}" alt=""></a>
					</div>
					<div class="team-content-wrap d-flex align-items-center justify-content-between">
						<div class="team-content">
							<h3><a href="teachers-details">Oliver Ava</a></h3>
			...
			<div class="col wow fadeIn" data-wow-duration="2.5s" data-wow-delay="1.2s">
				<div class="team-box team-box-design-2">
					<div class="team-img">
						<a href="teachers-details"><img class="w-100" src="{{ asset('Frontend_assets/images/team/team-6.png') }}" alt=""></a>
					</div>
					<div class="team-content-wrap d-flex align-items-center justify-content-between">
						<div class="team-content">
							<h3><a href="teachers-details">Kiam Ava</a></h3>
							<p>Educoda Manager</p>
						</div>
						<div class="team-social">
							<a href="#"><i class="bx bxl-facebook"></i></a>
